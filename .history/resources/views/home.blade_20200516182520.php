        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <hr>
                    ...
                    <a href="/post/edit" class="btn btn-outline-success my-2 my-sm-0" style=" width:50%; margin-bottom: 10px;" >Edit</a>
                    <a href="/post/delete" class="btn btn-outline-danger my-2 my-sm-0" style=" width:50%; margin-bottom: 10px;" >Delete</a>
                    </div>
                 </div>
            </div>
                    ...
                    @if(count($post) > 1)
                            @foreach($post as $post)
                                <div class="card mb-3" style = "margin-top:10px; margin-bottom:10px;">
                                        <img class="card-img-top" src=  "{{asset('storage/'.$post->file )}} " alt="no image">
