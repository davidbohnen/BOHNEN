        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <hr>
                    ...
                    <a href="/nope" class="btn btn-outline-success my-2 my-sm-0" style=" width:50%; margin-bottom: 10px;" >Edit</a>
                    <a href="/nope" class="btn btn-outline-danger my-2 my-sm-0" style=" width:50%; margin-bottom: 10px;" >Delete</a>
                    </div>
                 </div>
            </div>
