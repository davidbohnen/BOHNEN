    ...
    <div class="row justify-content-center my-auto">
        <div class="col-md-8">
            <div class="card">
                ...
                <a href="/post/create" class="btn btn-outline-primary my-2 my-sm-0" style=" width:50%" >Post</a>
                <a href="/post/create" class="btn btn-outline-warning my-2 my-sm-0" style=" width:50%" >Delete</a>
                <a href="/post/create" class="btn btn-outline-danger my-2 my-sm-0" style=" width:50%" >Delete</a>
                </div>
            </div>
        </div>
