...
<div class="container justify-content-center align-items-center" style = "padding:5px;" >

      

          <div id="left-col" class="col-sm-3" style="margin-left: auto; float:left">
          ...
          <div id = "middle-col" class="col-sm-5" style="float: left">
            <h4>Posts</h4>
            <hr>
            @if(count($post) > 1)
          ...
          <div id = "right-col" class="col-sm-3" style="float: left" >
            <h4>Latest News</h4>
            <hr>
                <div class="card" style="width: 100%; margin-top:10px; margin-bottom:10px; " >
