...
<div class="container" style = "padding:5px;" >
          ...
          <div id="left-col" class="col-3" style="margin-left: 50px; float:left">
          ...
          <div id = "middle-col" class="col-5" style="float: left">
            <h4>Posts</h4>
            <hr>
            @if(count($post) > 1)
          ...
          <div id = "right-col" class="col-3" style="float: left" >
            <h4>Latest News</h4>
            <hr>
                <div class="card" style="width: 100%; margin-top:10px; margin-bottom:10px; " >
