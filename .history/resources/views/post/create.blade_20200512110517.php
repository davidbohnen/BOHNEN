            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action = "/post" method="post" enctype="multipart/data">
                        ...
                        <input name = "file" type="file" class="form-control" id="file" aria-describedby="fileHelp" placeholder="Add file">
                        <small id="fileHelp" class="form-text text-muted">Add a file!</small>
