...
@if(count($post) > 1)
              @foreach($post as $post)
                   <div class="card mb-3" style = "margin-top:10px; margin-bottom:10px;" enctype="multipart/form-data">
                          <img name="file" class="card-img-top" enctype="multipart/form-data"  alt="no file" src=  "{{asset('storage/'.$post->file )}} " ></img>

                           <video id="file" class="video-js" controls preload="auto" width="200" height="100" data-setup="{}">
