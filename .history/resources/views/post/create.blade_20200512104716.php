...
<!-- 
                        ...
                        <div class="card mb-3" style = "margin-top:10px; margin-bottom:10px;">
                          <img class="card-img-top" src="images/liver.jpg" alt="no image">
                          <div class="card-body">
                          <label for="title">Title</label>
                            <h5 class="card-title"> <input name = "title" type="text" class="form-control" id="title" aria-describedby="titleHelp" placeholder="Enter Title"></h5>
                            <small id="titleHelp" class="form-text text-muted">Give your post a Title!</small>
