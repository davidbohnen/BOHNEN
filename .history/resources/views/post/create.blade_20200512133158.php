    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action = "/post" method="post" enctype="multipart/data">
                        @csrf 
                        ...
                        <input name = "image" type="image" class="form-control" id="image" aria-describedby="imageHelp" placeholder="Add Image">
                        <small id="imageHelp" class="form-text text-muted">Add a file!</small>
