    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action = "/store" method="post" enctype="multipart/data">
                        @csrf 
                        ...
                        <input name = "file" type="file" class="form-control-file" id="file" aria-describedby="fileHelp" placeholder="Add File" enctype="multipart/form-data">
