...
<div class="container" style = "padding:5px;" >
          ...
          <div class="col-3" style="margin-left: 50px;">
            ...
            <div class="card" style="width: 15rem; margin-top:10px; margin-bottom:10px; ">
              ...
              <ul class="list-group list-group-flush ">
                <li class="list-group-item list-group-item-action"><a href = "realmadrid.html" style="text-decoration: none;"> <img src="/images/real.png" style = "width:10% ; height: 10%;"> Real Madrid </a> </li>
                <ul><a href="#" class="btn btn-link" style="text-decoration: none;">Add</a></ul>
            ...
            <hr>
                ...
                <div class="card" style="width: 15rem; margin-top:10px; margin-bottom:10px;">
                  ...
                  <ul class="list-group list-group-flush ">
                    ...
                    <li class="list-group-item list-group-item-action"><a href = "#"  target="_blank" style="text-decoration: none;" ><img src="images/facebook.png" style = "width: 20 px ; height: 20px;"> Facebook </a></li>
                    <li class="list-group-item list-group-item-action"><a href = "#"  target="_blank" style="text-decoration: none;"><img src="images/twitter.png" style = "width: 20 px ; height: 20px;"> Twitter </a></li>
                    <li class="list-group-item list-group-item-action"><a href = "#"  target="_blank" style="text-decoration: none;"><img src="images/youtube.png" style = "width: 20 px ; height: 20px;"> Youtube </a></li>
                    <li class="list-group-item list-group-item-action"><a href = "#"  target="_blank" style="text-decoration: none;"><img src="images/snap.png" style = "width: 20 px ; height: 20px;"> Snapchat </a></li>
          ...
          <div class="col-3" >
            ...
            <hr>
                <div class="card" style="width: 18rem; margin-top:10px; margin-bottom:10px; ">
                  ...
                  <ul class="list-group list-group-flush ">
                    <li class="list-group-item list-group-item-action">Two more Europa League matches have been   <a href="#"  style="text-decoration: none;">More</a> </li>
                    <li class="list-group-item list-group-item-action">Italian Prime Minister Guiseppe Conte announced   <a href="#" style="text-decoration: none;" >More</a> </li>
                    <li class="list-group-item list-group-item-action">Mbappé Included in Squad to Face Dortmund   <a href="#" style="text-decoration: none;">More</a> </li>
                    <li class="list-group-item list-group-item-action">Inter’s Alexis Sanchez To Be Quarantined   <a href="#" style="text-decoration: none;">More</a> </li>
      ...
      <div class="card text-center" style="margin-top: 500px ;">
        ...
        <div class="card-body">
          ...
          <a href="#" class="btn btn-link" style="text-decoration: none;">Subscribe!</a>
        </div>
